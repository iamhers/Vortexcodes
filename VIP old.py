...
# Example usage
text = "RAINBOW COLORS"
live_text(rainbow_text('                This tool is by  ᎮᗯᑎᗩGƐ | Ѵᴏʀᴛᴇx • | @PwnageVortex'))
print("\033[1;94m" + "═" * 82)
blue = "\033[1m\033[34m"
green = "\033[1m\033[32m"
WDEH = render('Vortex', colors=['blue', 'green'], align='center')
live_text(WDEH)
print('')                                                               
print("\033[1;94m" + "═" * 82)
...
table.add_column("[ror]The Tool By :  ᎮᗯᑎᗩGƐ | Ѵᴏʀᴛᴇx •  ",style='green')
...
webbrowser.open('https://t.me/PwnageVortex')
